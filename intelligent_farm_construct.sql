...
(
    ...
    `action_details` text,
    `details_json`   json GENERATED ALWAYS AS (json_object(_utf8mb4'time_range', trim(substring_index(
            substring_index(`action_details`, _utf8mb4'时间范围:', -(1)), _utf8mb4' ', 2)), _utf8mb4'filename', nullif(
                                                                   substring_index(
                                                                           substring_index(`action_details`, _utf8mb4'文件名:', -(1)),
                                                                           _utf8mb4' ', 1), _utf8mb4''),
                                                           _utf8mb4'metrics', json_object(_utf8mb4'temperature', nullif(
                    substring_index(substring_index(`action_details`, _utf8mb4'温度:', -(1)), _utf8mb4' ', 1),
                    _utf8mb4''), _utf8mb4'humidity', nullif(substring_index(
                                                                    substring_index(`action_details`, _utf8mb4'湿度:', -(1)),
                                                                    _utf8mb4' ', 1), _utf8mb4''),
                                                                                          _utf8mb4'soil_moisture',
                                                                                          nullif(substring_index(
                                                                                                         substring_index(`action_details`, _utf8mb4'土壤湿度:', -(1)),
                                                                                                         _utf8mb4' ',
                                                                                                         1),
                                                                                                 _utf8mb4'')))) VIRTUAL,
